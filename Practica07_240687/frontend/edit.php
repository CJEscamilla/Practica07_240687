...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tb_users set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email', Address='$add' where ID='$eid'");
     
    if ($query) {
    echo "<script>alert('Se han actualizado los datos del Usuario');</script>";
    echo "<script type='text/javascript'> document.location ='index.php'; </script>";
  }
  else
    {
      echo "<script>alert('Oopss. algo falló.');</script>";
    }
}
?>
<!DOCTYPE html>
...
<div class="signup-form">
 ...
 <?php
$eid=$_GET['editid'];
$ret=mysqli_query($con,"select * from tb_users where ID='$eid'");
while ($row=mysqli_fetch_array($ret)) {
?>
		<h2>Actualización de <b>Usuario</b></h2>
		<p class="hint-text">Modifica los datos que necesites:</p>
